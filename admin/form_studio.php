...
if (isset($_POST['tambahkan'])) {
	if (tambahStudio($_POST) > 0) {
		...
		document.location.href = 'form_studio.php';
		</script>";
	}
}
            ...
            <div class="col-lg-8 mx-auto">
                <div class="card">
                    <div class="card-header py-3 bg-transparent">
                        <h5 class="mb-0 h4 text-center">Form Tambah Studio</h5>
                    </div>
                    <div class="card-body">
                            ...
                            <form action="" method="post" class="row g-3" enctype="multipart/form-data">
                                <div class="col-12">
                                    <div class="input-group">
                                        <select class="form-select border-dark" name="id_film">
                                            <option selected>Pilih Film</option>
                                            <?php
                                            $row = mysqli_query($conn, "SELECT * FROM tabel_film");
                                            ?>
                                            <?php foreach ($row as $data) : ?>
                                                <option value="<?= $data['id_film']; ?>" name="id_film"> <?= $data['nama_film']; ?> </option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control border-dark" name="nama_studio" required>
                                </div>

                                <div class="col-12">
                                    <label class="form-label">Alamat</label>
                                    <input type="text" class="form-control border-dark" name="alamat" required>
                                </div>

                                <div class="col-12">
                                    <label class="form-label">Nomor Telepon</label>
                                    <input type="text" class="form-control border-dark" name="nomor_telp" required>
                                </div>

                                <div class="col-12">
                                    <label class="form-label">Poster Studio</label>
                                    <input class="form-control border-dark" type="file" name="gambar">
                                </div>

                                <div class="col-12">
                                    <label class="form-label">Harga Tiket</label>
                                    <input type="text" class="form-control border-dark" name="harga_tiket" required>
                                </div>
