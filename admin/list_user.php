...
$query = mysqli_query($conn, "SELECT * FROM users WHERE role_akun = 2");
$no = 1;
...
<body>
            ...
            <div class="offcanvas offcanvas-start text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="list_user.php">
    ...
    <div class="container">
        <div class="row" style="margin-top: 120px; margin-bottom: 50px;">
            <div class="col">
                <h3 class="my-3 text-center">Tabel User</h3>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="d-none d-md-table-cell">
                                    <a href="hapus_user.php?id=<?= $user['id_user'];?>" class="btn btn-danger">Hapus</a>
                                </td>
                            </tr>
                        </tbody>
                    <?php endforeach; ?>
